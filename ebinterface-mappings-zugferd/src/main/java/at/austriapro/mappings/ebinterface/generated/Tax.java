 ...
 *         &lt;element ref="{http://www.ebinterface.at/schema/4p1/}OtherTax" maxOccurs="unbounded"
 * minOccurs="0"/>
 *         &lt;element ref="{http://www.ebinterface.at/schema/4p1/extensions/ext}TaxExtension"
 * minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
...
public class Tax
   ...
   * there is not a <CODE>set</CODE> method for the otherTaxes property.
   *
   ...
   *
   *
   * <p> Objects of the following type(s) are allowed in the list {@link OtherTax }
   */
   ...
   *
   * @return possible object is {@link TaxExtension }
   */
   ...
   *
   * @param value allowed object is {@link TaxExtension }
   */
