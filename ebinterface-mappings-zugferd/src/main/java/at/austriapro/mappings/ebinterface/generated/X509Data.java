...
public class X509Data implements Serializable {
   ...
   * there is not a <CODE>set</CODE> method for the x509IssuerSerialsAndX509SKISAndX509SubjectNames
   * property.
   *
   ...
   * <}{@link byte[]}{@code >} {@link JAXBElement }{@code <}{@link byte[]}{@code >} {@link
   * JAXBElement }{@code <}{@link String }{@code >} {@link JAXBElement }{@code <}{@link
   * X509IssuerSerialType }{@code >} {@link Element } {@link JAXBElement }{@code <}{@link
   * byte[]}{@code >}
   */
  ...
  public X509Data withX509IssuerSerialsAndX509SKISAndX509SubjectNames(
      Collection<java.lang.Object> values) {
    if (values != null) {
