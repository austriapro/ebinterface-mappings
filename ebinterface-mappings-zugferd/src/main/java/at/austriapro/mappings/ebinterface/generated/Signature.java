 ...
 *         &lt;element ref="{http://www.w3.org/2000/09/xmldsig#}Object" maxOccurs="unbounded"
 * minOccurs="0"/>
 *       &lt;/sequence>
...
public class Signature
   ...
   *
   * @param value allowed object is {@link SignedInfo }
   */
   ...
   *
   * @param value allowed object is {@link SignatureValue }
   */
   ...
   *
   * @param value allowed object is {@link KeyInfo }
   */
   ...
   * there is not a <CODE>set</CODE> method for the objects property.
   *
  ...
  public Signature withObjects(Object... values) {
    if (values != null) {
  ...
  public Signature withObjects(Collection<Object> values) {
    if (values != null) {
