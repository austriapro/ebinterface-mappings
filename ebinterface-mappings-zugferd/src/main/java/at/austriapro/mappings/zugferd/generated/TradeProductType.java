...
public class TradeProductType {
    ...
    public TradeProductType withApplicableProductCharacteristic(Collection<ProductCharacteristicType> values) {
        if (values!= null) {
    ...
    public TradeProductType withDesignatedProductClassification(Collection<ProductClassificationType> values) {
        if (values!= null) {
