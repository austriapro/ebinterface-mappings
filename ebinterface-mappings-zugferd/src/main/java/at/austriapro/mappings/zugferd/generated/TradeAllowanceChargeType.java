 ...
 *       &lt;sequence>
 *         &lt;element name="ChargeIndicator" type="{urn:un:unece:uncefact:data:standard:UnqualifiedDataType:15}IndicatorType"
 * minOccurs="0"/>
 *         &lt;element name="SequenceNumeric" type="{urn:un:unece:uncefact:data:standard:UnqualifiedDataType:15}NumericType"
 * minOccurs="0"/>
 ...
 * minOccurs="0"/>
 *         &lt;element name="ActualAmount" type="{urn:un:unece:uncefact:data:standard:UnqualifiedDataType:15}AmountType"
 * maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="ReasonCode" type="{urn:un:unece:uncefact:data:standard:QualifiedDataType:12}AllowanceChargeReasonCodeType"
 * minOccurs="0"/>
 *         &lt;element name="Reason" type="{urn:un:unece:uncefact:data:standard:UnqualifiedDataType:15}TextType"
 * minOccurs="0"/>
 *         &lt;element name="CategoryTradeTax" type="{urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:12}TradeTaxType"
 * maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
...
public class TradeAllowanceChargeType {
   ...
   * there is not a <CODE>set</CODE> method for the actualAmount property.
   *
   ...
   *
   * @return possible object is {@link AllowanceChargeReasonCodeType }
   */
   ...
   *
   * @param value allowed object is {@link AllowanceChargeReasonCodeType }
   */
   ...
   * <p> This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the categoryTradeTax property.
   *
   * <p> For example, to add a new item, do as follows:
   * <pre>
