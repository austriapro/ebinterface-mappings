...
public class TradePaymentTermsType {
    ...
    public TradePaymentTermsType withApplicableTradePaymentPenaltyTerms(TradePaymentPenaltyTermsType... values) {
        if (values!= null) {
    ...
    public TradePaymentTermsType withApplicableTradePaymentPenaltyTerms(Collection<TradePaymentPenaltyTermsType> values) {
        if (values!= null) {
    ...
    public TradePaymentTermsType withApplicableTradePaymentDiscountTerms(TradePaymentDiscountTermsType... values) {
        if (values!= null) {
    ...
    public TradePaymentTermsType withApplicableTradePaymentDiscountTerms(Collection<TradePaymentDiscountTermsType> values) {
        if (values!= null) {
