...
public class TradeContactType {
    ...
    public TradeContactType withTelephoneUniversalCommunication(UniversalCommunicationType... values) {
        if (values!= null) {
    ...
    public TradeContactType withTelephoneUniversalCommunication(Collection<UniversalCommunicationType> values) {
        if (values!= null) {
    ...
    public TradeContactType withFaxUniversalCommunication(Collection<UniversalCommunicationType> values) {
        if (values!= null) {
