...
public class ZUGFeRDMappingFromEbInterface4p1 extends Mapping {
  ...
  public ZUGFeRDMappingFromEbInterface4p1(final MappingFactory.ZugferdMappingType zugferdMappingType) {
  ...
  public byte[] mapFromebInterface(final byte[] ebinterface) throws MappingException {
    ...
    final Ebi41InvoiceType invoice = EbInterfaceReader.ebInterface41 ().read (ebinterface);
   ...
   */
  private CrossIndustryDocumentType performMapping(final Ebi41InvoiceType invoice) {
  ...
  private void mapPresentationDetails(final CrossIndustryDocumentType zugferd,
                                      final Ebi41PresentationDetailsType presentationDetails) {
  ...
  private void mapPaymentConditions(final CrossIndustryDocumentType zugferd,
                                    final Ebi41PaymentConditionsType paymentConditions) {
    if (!MappingFactory.ZugferdMappingType.ZUGFeRD_BASIC_1p0.equals(zugferdMappingType)
      ...
      if (MappingFactory.ZugferdMappingType.ZUGFeRD_EXTENDED_1p0.equals(zugferdMappingType)
        ...
        for (final Ebi41DiscountType discount : paymentConditions.getDiscount()) {
   ...
   */
  private void mapPaymentMethod(final CrossIndustryDocumentType zugferd, final Ebi41PaymentMethodType paymentMethod) {
    if (paymentMethod != null) {
      ...
      if (paymentMethod.getDirectDebit() != null) {
        ...
        for (final Ebi41AccountType ba : paymentMethod.getUniversalBankTransaction()
   ...
   */
  private void mapTax(final CrossIndustryDocumentType zugferd, final Ebi41TaxType tax) {
    ...
    if (tax != null) {
      ...
      if (tax.getVAT() != null && tax.getVAT().getVATItem().size() > 0) {
        ...
        for (final Ebi41VATItemType vATItems : tax.getVAT().getVATItem()) {
      ...
      if (tax.getOtherTax() != null && tax.getOtherTax().size() > 0) {
        ...
        for (final Ebi41OtherTaxType otherTax : tax.getOtherTax()) {
  ...
  private void mapReductionAndSurchargeDetails(final CrossIndustryDocumentType zugferd,
                                               final Ebi41ReductionAndSurchargeDetailsType reductionAndSurchargeDetails) {
    if (!MappingFactory.ZugferdMappingType.ZUGFeRD_BASIC_1p0.equals(zugferdMappingType)
      ...
      if (reductionAndSurchargeDetails.getReductionOrSurchargeOrOtherVATableTax () != null
        ...
        for (final JAXBElement<?> rSVItem : reductionAndSurchargeDetails
          ...
          if (aValue instanceof Ebi41OtherVATableTaxType) {
            ...
            final Ebi41OtherVATableTaxType
                oVatItem =
                (Ebi41OtherVATableTaxType) aValue;
            ...
            final Ebi41ReductionAndSurchargeType
                rsItem =
                (Ebi41ReductionAndSurchargeType) aValue;
   ...
   */
  private void mapDetails(final CrossIndustryDocumentType zugferd, final Ebi41DetailsType details) {
    ...
    if (details != null) {
      ...
      if (details.getItemList() != null && details.getItemList().size() > 0) {
        ...
        for (final Ebi41ItemListType itemList : details.getItemList()) {
          ...
          if (itemList.getListLineItem() != null && itemList.getListLineItem().size() > 0) {
            ...
            for (final Ebi41ListLineItemType item : itemList.getListLineItem()) {
              ...
              if (!MappingFactory.ZugferdMappingType.ZUGFeRD_BASIC_1p0.equals(zugferdMappingType)) {
                ...
                if (item.getArticleNumber() != null && item.getArticleNumber().size() > 0) {
                  ...
                  for (final Ebi41ArticleNumberType art : item.getArticleNumber()) {
                ...
                if (item
                  ...
                  for (final JAXBElement<?> rSVItem : item
                    ...
                    if (rSVItem.getName().getLocalPart().equals("ReductionListLineItem") || rSVItem
                      ...
                      final Ebi41ReductionAndSurchargeBaseType
                          rsItem =
                          (Ebi41ReductionAndSurchargeBaseType) rSVItem.getValue();
                      ...
                      final Ebi41OtherVATableTaxBaseType
                          otherTaxItem =
                          (Ebi41OtherVATableTaxBaseType) rSVItem.getValue();
              ...
              if (MappingFactory.ZugferdMappingType.ZUGFeRD_EXTENDED_1p0.equals(zugferdMappingType)
                ...
                final Ebi41AdditionalInformationType ai = item.getAdditionalInformation();
                ...
                if (ai.getClassification() != null && ai.getClassification().size() > 0) {
                  for (final Ebi41ClassificationType cl : ai.getClassification()) {
   ...
   */
  private void mapRootAttributes(final CrossIndustryDocumentType zugferd, final Ebi41InvoiceType invoice) {
    //ZUGFeRD type
    ...
    final String documentCurrency = invoice.getInvoiceCurrency().value();
    zugferd.getSpecifiedSupplyChainTradeTransaction().getApplicableSupplyChainTradeSettlement()
   ...
   */
  private void mapOrderingParty(final CrossIndustryDocumentType zugferd, final Ebi41OrderingPartyType orderingParty) {
    ...
    if (MappingFactory.ZugferdMappingType.ZUGFeRD_EXTENDED_1p0.equals(zugferdMappingType)) {
      ...
      if (orderingParty.getFurtherIdentification() != null
        ...
        for (final Ebi41FurtherIdentificationType furtherIdentification : orderingParty
      ...
      if (orderingParty.getAddress().getAddressIdentifier() != null
        ...
        for (final Ebi41AddressIdentifierType aId : orderingParty.getAddress().getAddressIdentifier()) {
          //ebInterface: /Invoice/OrderingParty/Address/AddressIdentifier
          String schema;
          if (aId.getAddressIdentifierType()
              .equals(Ebi41AddressIdentifierTypeType.DUNS)) {
            schema = "0060";
          } else if (aId.getAddressIdentifierType()
              .equals(Ebi41AddressIdentifierTypeType.GLN)) {
            schema = "0088";
  ...
  private void mapInvoiceRecipient(final CrossIndustryDocumentType zugferd,
                                   final Ebi41InvoiceRecipientType invoiceRecipient) {
    ...
    if (invoiceRecipient.getFurtherIdentification() != null
      ...
      //ebInterface: /Invoice/InvoiceRecipient/FurtherIdentification
      for (final Ebi41FurtherIdentificationType furtherIdentification : invoiceRecipient
          .getFurtherIdentification()) {
    ...
    if (!MappingFactory.ZugferdMappingType.ZUGFeRD_BASIC_1p0.equals(zugferdMappingType)
      ...
      for (final Ebi41AddressIdentifierType aId : invoiceRecipient.getAddress().getAddressIdentifier()) {
   ...
   */
  private void mapBiller(final CrossIndustryDocumentType zugferd, final Ebi41BillerType biller) {
    ...
    if (biller.getFurtherIdentification() != null
      ...
      //ebInterface: /Invoice/InvoiceRecipient/FurtherIdentification
      for (final Ebi41FurtherIdentificationType furtherIdentification : biller
          .getFurtherIdentification()) {
    ...
    if (!MappingFactory.ZugferdMappingType.ZUGFeRD_BASIC_1p0.equals(zugferdMappingType)
      ...
      for (final Ebi41AddressIdentifierType aId : biller.getAddress().getAddressIdentifier()) {
  ...
  private void mapRelatedDocuments(final CrossIndustryDocumentType zugferd,
                                   final List<Ebi41RelatedDocumentType> relatedDocuments) {
    ...
    for (final Ebi41RelatedDocumentType relatedDocument : relatedDocuments) {
  ...
  private void mapCancelledOriginalDocument(final CrossIndustryDocumentType zugferd,
                                            final Ebi41CancelledOriginalDocumentType cancelledOriginalDocument) {
   ...
   */
  private void mapDelivery(final CrossIndustryDocumentType zugferd, final Ebi41DeliveryType delivery) {
   ...
   */
  private String getDocumentType(final Ebi41InvoiceType invoice) {

    if (Ebi41DocumentTypeType.SELF_BILLING.equals(invoice.getDocumentType())) {
      return "BELASTUNGSANZEIGE";
    } else if (Ebi41DocumentTypeType.CREDIT_MEMO.equals(invoice.getDocumentType())) {
      return "GUTSCHRIFT";
    } else {
      return "RECHNUNG";
    }
   ...
   */
  private String getDocumentTypeCode(final Ebi41InvoiceType invoice) {
  ...
  private TradeAddressType getTradeAddressType(final Ebi41AddressType address) {
    ...
    if (address.getCountry() != null && address.getCountry().getCountryCode() != null) {
      tat.withCountryID(new CountryIDType().withValue(
          address.getCountry().getCountryCode().value()));
    } else if (address.getCountry() != null){
      tat.withCountryID(new CountryIDType().withValue(
          address.getCountry().getContent()));
    }
  ...
  private TradeContactType getTradeContactType(final Ebi41AddressType address) {
