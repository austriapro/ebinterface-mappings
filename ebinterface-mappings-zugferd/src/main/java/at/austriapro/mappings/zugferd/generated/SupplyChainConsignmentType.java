...
public class SupplyChainConsignmentType {
    ...
    public SupplyChainConsignmentType withSpecifiedLogisticsTransportMovement(LogisticsTransportMovementType... values) {
        if (values!= null) {
    ...
    public SupplyChainConsignmentType withSpecifiedLogisticsTransportMovement(Collection<LogisticsTransportMovementType> values) {
        if (values!= null) {
