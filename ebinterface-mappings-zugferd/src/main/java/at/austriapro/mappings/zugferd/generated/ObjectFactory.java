 ...
 * generated in the at.austriapro.mappings.zugferd.generated package. <p>An ObjectFactory allows you
...
public class ObjectFactory {
  ...
  private final static QName
      _CrossIndustryDocument_QNAME =
      new QName("urn:ferd:CrossIndustryDocument:invoice:1p0", "CrossIndustryDocument");

  /**
   * Create a new ObjectFactory that can be used to create new instances of schema derived classes
   * for package: at.austriapro.mappings.zugferd.generated
   */
  ...
  public JAXBElement<CrossIndustryDocumentType> createCrossIndustryDocument(
      CrossIndustryDocumentType value) {
    return new JAXBElement<CrossIndustryDocumentType>(_CrossIndustryDocument_QNAME,
                                                      CrossIndustryDocumentType.class, null, value);
  }
