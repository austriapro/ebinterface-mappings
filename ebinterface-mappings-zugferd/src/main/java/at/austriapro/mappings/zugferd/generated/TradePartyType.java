 ...
 * minOccurs="0"/>
 *         &lt;element name="DefinedTradeContact" type="{urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:12}TradeContactType"
 * maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="PostalTradeAddress" type="{urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:12}TradeAddressType"
 * minOccurs="0"/>
 *         &lt;element name="SpecifiedTaxRegistration" type="{urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:12}TaxRegistrationType"
 * maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
...
public class TradePartyType {
   ...
   * <p> This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the definedTradeContact property.
   *
   * <p> For example, to add a new item, do as follows:
   * <pre>
   ...
   *
   *
   * <p> Objects of the following type(s) are allowed in the list {@link TradeContactType }
   */
   ...
   *
   * @return possible object is {@link TradeAddressType }
   */
   ...
   *
   * @param value allowed object is {@link TradeAddressType }
   */
   ...
   * <p> This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the specifiedTaxRegistration property.
   *
   * <p> For example, to add a new item, do as follows:
   * <pre>
   ...
   *
   *
   * <p> Objects of the following type(s) are allowed in the list {@link TaxRegistrationType }
   */
