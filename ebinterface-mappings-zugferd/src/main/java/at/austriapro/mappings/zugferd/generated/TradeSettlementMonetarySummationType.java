...
public class TradeSettlementMonetarySummationType {
    ...
    public TradeSettlementMonetarySummationType withAllowanceTotalAmount(Collection<AmountType> values) {
        if (values!= null) {
    ...
    public TradeSettlementMonetarySummationType withTaxBasisTotalAmount(Collection<AmountType> values) {
        if (values!= null) {
    ...
    public TradeSettlementMonetarySummationType withTotalPrepaidAmount(Collection<AmountType> values) {
        if (values!= null) {
    ...
    public TradeSettlementMonetarySummationType withTotalAllowanceChargeAmount(Collection<AmountType> values) {
        if (values!= null) {
