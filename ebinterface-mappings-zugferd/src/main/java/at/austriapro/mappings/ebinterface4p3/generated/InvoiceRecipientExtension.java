 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.ebinterface.at/schema/4p3/extensions/sv}InvoiceRecipientExtension" minOccurs="0"/>
...
@XmlType(name = "InvoiceRecipientExtensionType", namespace = "http://www.ebinterface.at/schema/4p3/extensions/ext", propOrder = {
    "invoiceRecipientExtension",
    "custom"
})
@XmlRootElement(name = "InvoiceRecipientExtension", namespace = "http://www.ebinterface.at/schema/4p3/extensions/ext")
public class InvoiceRecipientExtension
    implements Serializable
{

    @XmlElement(name = "InvoiceRecipientExtension", namespace = "http://www.ebinterface.at/schema/4p3/extensions/sv")
